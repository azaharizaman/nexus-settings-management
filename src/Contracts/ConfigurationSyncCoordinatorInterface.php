...
/**
 * Coordinator interface for managing configuration synchronization (import/export/rollback).
 */
interface ConfigurationSyncCoordinatorInterface extends SettingsCoordinatorInterfaceBase
{
    /**
